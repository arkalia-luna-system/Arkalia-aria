...
class TestDashboardCorrelations:
    ...
    def test_sleep_pain_correlation_endpoint(self, client):
    ...
    def test_stress_pain_correlation_endpoint(self, client):
    ...
    def test_correlation_with_different_periods(self, client):
